...
-l"D:\WorkLocation\Projects\TRS_appC0\Debug\configPkg\package\cfg\TRS_SYSBIOS_pe66.oe66"
-l"D:\WorkLocation\Projects\TRS_appC0\src\ipc\ipc.ae66"
-l"D:\WorkLocation\Projects\TRS_appC0\src\utils\utils.ae66"
-l"D:\WorkLocation\Projects\TRS_appC0\src\sysbios\sysbios.ae66"
...
MEMORY
{
    ...
    C0_DATA_RAM (RW) : org = 0x83000000, len = 0x400000
    CX_CRITICAL_SECTION (RW) : org = 0x80000000, len = 0x100000
    CX_CRITICAL_SECTION_REFERENCE (RW) : org = 0x80100000, len = 0x1000
    CORE_HEALTH (RW) : org = 0x81af1a00, len = 0x50e600
    MSMCSRAM (RW) : org = 0xc000000, len = 0x400000
    C0_NON_CACHE (RW) : org = 0x85000000, len = 0x400000
...
/* Content from myBoard_Core0_m (null): */
...
SECTIONS
{
    ...
    .stack: load > L2RAM
    GROUP: load > C0_DATA_RAM
    {
        .bss:
        .neardata:
        .rodata:
    }
    .cinit: load > C0_DATA_RAM
    .pinit: load >> C0_DATA_RAM
    .init_array: load > C0_DATA_RAM
    .const: load >> L2RAM
    .data: load >> C0_DATA_RAM
    .fardata: load >> C0_DATA_RAM
    .switch: load >> C0_DATA_RAM
    .sysmem: load > C0_DATA_RAM
    .far: load >> C0_DATA_RAM
    .args: load > C0_DATA_RAM align = 0x4, fill = 0 {_argsize = 0x0; }
    .cio: load >> C0_DATA_RAM
    .ti.handler_table: load > C0_DATA_RAM
    .c6xabi.exidx: load > C0_DATA_RAM
    .c6xabi.extab: load >> C0_DATA_RAM
    systemheap: load > C0_DATA_RAM
    ethernetmemorybuffer: load > C0_NON_CACHE
    .dataL1D: load > L1D_RAM
    .qmss: load > C0_NON_CACHE
    .cppi: load > C0_NON_CACHE
    .hostregion: load > C0_NON_CACHE
    .srioSharedMem: load > C0_NON_CACHE
    .dataL2: load > L2RAM
    .SrioSlaveBuff: load > MSMCSRAM
    .critical_section_reference: load > CX_CRITICAL_SECTION_REFERENCE
    .critical_section: load > CX_CRITICAL_SECTION
    .fasttext:: load > L2RAM
    .csl_vect: load > L2RAM
    .vectors: load > L2RAM
    .printf: load > C0_DATA_RAM
    .switch:: load > C0_DATA_RAM
    .cio:: load > C0_DATA_RAM
    .delcomObj: load > C0_DATA_RAM
    .cinit:: load > L2RAM
    .ddrdata: load > C0_NON_CACHE
    .textL1P: load > L1P_RAM
    .nocache: load > C0_NON_CACHE
    .far:taskStackSection: load > C0_DATA_RAM
    .vecs: load > L2RAM
