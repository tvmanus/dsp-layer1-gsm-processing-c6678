...
-l"D:\WorkLocation\Projects\TRS_appC3\Debug\configPkg\package\cfg\TRS_SYSBIOS_pe66.oe66"
-l"D:\WorkLocation\Projects\TRS_appC3\src\ipc\ipc.ae66"
-l"D:\WorkLocation\Projects\TRS_appC3\src\utils\utils.ae66"
-l"D:\WorkLocation\Projects\TRS_appC3\src\sysbios\sysbios.ae66"
...
MEMORY
{
    ...
    C3_DATA_RAM (RW) : org = 0x83c00000, len = 0x400000
    CX_CRITICAL_SECTION_REFERENCE (RW) : org = 0x80100000, len = 0x1000
    C3_NON_CACHE (RW) : org = 0x85c00000, len = 0x400000
...
/* Content from myBoard_Core3m (null): */
...
SECTIONS
{
    ...
    .stack: load > L2RAM
    GROUP: load > C3_DATA_RAM
    {
        .bss:
        .neardata:
        .rodata:
    }
    .cinit: load > C3_DATA_RAM
    .pinit: load >> C3_DATA_RAM
    .init_array: load > C3_DATA_RAM
    .const: load >> L2RAM
    .data: load >> C3_DATA_RAM
    .fardata: load >> C3_DATA_RAM
    .switch: load >> C3_DATA_RAM
    .sysmem: load > C3_DATA_RAM
    .far: load >> C3_DATA_RAM
    .args: load > C3_DATA_RAM align = 0x4, fill = 0 {_argsize = 0x0; }
    .cio: load >> C3_DATA_RAM
    .ti.handler_table: load > C3_DATA_RAM
    .c6xabi.exidx: load > C3_DATA_RAM
    .c6xabi.extab: load >> C3_DATA_RAM
    systemheap: load > C3_DATA_RAM
    ...
    .csl_vect: load > L2RAM
    .vectors: load > L2RAM
    .printf: load > C3_DATA_RAM
    .switch:: load > C3_DATA_RAM
    .cio:: load > C3_DATA_RAM
    .cinit:: load > L2RAM
    .delcomObj: load > C3_DATA_RAM
    .ddrdata: load > C3_NON_CACHE
    .textL1P: load > L1P_RAM
    .nocache: load > C3_NON_CACHE
    .far:taskStackSection: load > C3_DATA_RAM
    .vecs: load > L2RAM
