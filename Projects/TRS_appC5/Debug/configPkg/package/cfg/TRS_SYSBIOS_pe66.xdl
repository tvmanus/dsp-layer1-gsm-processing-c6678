...
-l"D:\WorkLocation\Projects\TRS_appC5\Debug\configPkg\package\cfg\TRS_SYSBIOS_pe66.oe66"
-l"D:\WorkLocation\Projects\TRS_appC5\src\ipc\ipc.ae66"
-l"D:\WorkLocation\Projects\TRS_appC5\src\utils\utils.ae66"
-l"D:\WorkLocation\Projects\TRS_appC5\src\sysbios\sysbios.ae66"
...
MEMORY
{
    ...
    C5_DATA_RAM (RW) : org = 0x84400000, len = 0x400000
    CX_CRITICAL_SECTION_REFERENCE (RW) : org = 0x80100000, len = 0x1000
    C5_NON_CACHE (RW) : org = 0x86400000, len = 0x400000
...
/* Content from myBoard_Core5_m (null): */
...
SECTIONS
{
    ...
    .stack: load > L2RAM
    GROUP: load > C5_DATA_RAM
    {
        .bss:
        .neardata:
        .rodata:
    }
    .cinit: load > C5_DATA_RAM
    .pinit: load >> C5_DATA_RAM
    .init_array: load > C5_DATA_RAM
    .const: load >> L2RAM
    .data: load >> C5_DATA_RAM
    .fardata: load >> C5_DATA_RAM
    .switch: load >> C5_DATA_RAM
    .sysmem: load > C5_DATA_RAM
    .far: load >> C5_DATA_RAM
    .args: load > C5_DATA_RAM align = 0x4, fill = 0 {_argsize = 0x0; }
    .cio: load >> C5_DATA_RAM
    .ti.handler_table: load > C5_DATA_RAM
    .c6xabi.exidx: load > C5_DATA_RAM
    .c6xabi.extab: load >> C5_DATA_RAM
    systemheap: load > C5_DATA_RAM
    ...
    .csl_vect: load > L2RAM
    .vectors: load > L2RAM
    .printf: load > C5_DATA_RAM
    .switch:: load > C5_DATA_RAM
    .cio:: load > C5_DATA_RAM
    .cinit:: load > L2RAM
    .delcomObj: load > C5_DATA_RAM
    .ddrdata: load > C5_NON_CACHE
    .textL1P: load > L1P_RAM
    .nocache: load > C5_NON_CACHE
    .far:taskStackSection: load > C5_DATA_RAM
    .vecs: load > L2RAM
