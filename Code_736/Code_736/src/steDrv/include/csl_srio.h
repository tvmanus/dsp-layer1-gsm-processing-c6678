 ...
 * 19-Aug-2008 Added support for ...ICRR in srioHwControl                   
 * ============================================================================
 */
...
typedef enum {
    ...
    /**
     * @brief   Sets DOORBELL interrupt destination routing registers
     *
     * @param	CSL_SrioICRRData *
     */
    CSL_SRIO_CMD_DOORBELL_INTDST_ROUTE = 19,
    
    /**
     * @brief   Sets RX_CPPI interrupt destination routing registers
     *
     * @param	CSL_SrioICRRData *
     */
    CSL_SRIO_CMD_RX_CPPI_INTDST_ROUTE = 20,
    
    /**
     * @brief   Sets TX_CPPI interrupt destination routing registers
     *
     * @param	CSL_SrioICRRData *
     */
    CSL_SRIO_CMD_TX_CPPI_INTDST_ROUTE = 21,
    
    /**
     * @brief   Sets LSU interrupt destination routing registers
     *
     * @param	CSL_SrioICRRData *
     */
    CSL_SRIO_CMD_LSU_INTDST_ROUTE = 22,
    
    /**
     * @brief   Sets ERR_RST_EVNT interrupt destination routing registers
     *
     * @param	CSL_SrioICRRData *
     */
    CSL_SRIO_CMD_ERR_RST_EVNT_INTDST_ROUTE = 23
...
typedef enum {
	...
	CSL_SRIO_PORT_WIDTH_LANE_0 = 2,

    /** Force single lane, lane 2 */
    CSL_SRIO_PORT_WIDTH_LANE_2 = 3
...
/**
 * @brief This structure is used to hold the configuration information
 *        of different Interrupt routing registers
 */
typedef struct {
    /** Port selection */
    Uint32 index;
...
typedef struct {
     ...
     */
    CSL_SrioPktFwdCntl pktFwdCntl[CSL_SRIO_PORTS_MAX];

    /** SERDES PLL configure */ 
    CSL_SrioSerDesPllCfg serDesPllCfg;
    
    /** SERDES RX channel configure */
    CSL_SrioSerDesRxCfg serDesRxChannelCfg[CSL_SRIO_PORTS_MAX];

    /** SERDES TX channel configure */
    CSL_SrioSerDesTxCfg serDesTxChannelCfg[CSL_SRIO_PORTS_MAX];
    ...
    CSL_SrioPortCntlConfig  portCntlSetup[CSL_SRIO_PORTS_MAX];
    ...
    CSL_SrioPortErrConfig portErrSetup[CSL_SRIO_PORTS_MAX];
    ...
    CSL_SrioSilenceTimer silenceTimer[CSL_SRIO_PORTS_MAX];

    /** Port control independent error reporting enable. Macros can be OR’ed
     *  to get the value
     */
    Uint32 portCntlIndpEn[CSL_SRIO_PORTS_MAX];
} CSL_SrioHwSetup;
...
typedef struct {
    ...
    Uint32 INTDST_RATE_CNTL[8];
    
    /** LSU registers */
    CSL_SrioCfgLsuRegs LSU[CSL_SRIO_PORTS_MAX];
    ...
    /** Port registers */
    CSL_SrioCfgPortRegs PORT[CSL_SRIO_PORTS_MAX];
    ...
    /** Port error CSR */
    CSL_SrioCfgPortErrorRegs PORT_ERROR[CSL_SRIO_PORTS_MAX];
    ...
    /** Port options CSR */
    CSL_SrioCfgPortOptionRegs PORT_OPTION[CSL_SRIO_PORTS_MAX];

    /** DOORBELL interrupt dst routing */
    Uint32 DOORBELL_ICRR[4];
    Uint32 DOORBELL_ICRR2[4];

    /** RX_CPPI interrupt dst routing */
    Uint32 RX_CPPI_ICRR;
    Uint32 RX_CPPI_ICRR2;

    /** TX_CPPI interrupt dst routing */
    Uint32 TX_CPPI_ICRR;
    Uint32 TX_CPPI_ICRR2;

    /** LSU interrupt dst routing */
    Uint32 LSU_ICRR[4];

    /** ERR_RST_EVNT interrupt dst routing */
    Uint32 ERR_RST_EVNT_ICRR;
    Uint32 ERR_RST_EVNT_ICRR2;
    Uint32 ERR_RST_EVNT_ICRR3;
...
#define CSL_SRIO_CONFIG_DEFAULTS { \
    ...
    {\
        CSL_SRIO_DOORBELL_ICRR_RESETVAL,  \
        CSL_SRIO_DOORBELL_ICRR_RESETVAL,  \
        CSL_SRIO_DOORBELL_ICRR_RESETVAL,  \
        CSL_SRIO_DOORBELL_ICRR_RESETVAL  \
    },\
    {\
        CSL_SRIO_DOORBELL_ICRR2_RESETVAL, \
        CSL_SRIO_DOORBELL_ICRR2_RESETVAL, \
        CSL_SRIO_DOORBELL_ICRR2_RESETVAL, \
        CSL_SRIO_DOORBELL_ICRR2_RESETVAL \
    },\
    CSL_SRIO_RX_CPPI_ICRR_RESETVAL ,\
    CSL_SRIO_RX_CPPI_ICRR2_RESETVAL, \
    CSL_SRIO_TX_CPPI_ICRR_RESETVAL, \
    CSL_SRIO_TX_CPPI_ICRR2_RESETVAL, \
    {\
        CSL_SRIO_LSU_ICRR_RESETVAL, \
        CSL_SRIO_LSU_ICRR_RESETVAL, \
        CSL_SRIO_LSU_ICRR_RESETVAL, \
        CSL_SRIO_LSU_ICRR_RESETVAL \
    },\
    CSL_SRIO_ERR_RST_EVNT_ICRR_RESETVAL, \
    CSL_SRIO_ERR_RST_EVNT_ICRR2_RESETVAL, \
    CSL_SRIO_ERR_RST_EVNT_ICRR3_RESETVAL \
}
