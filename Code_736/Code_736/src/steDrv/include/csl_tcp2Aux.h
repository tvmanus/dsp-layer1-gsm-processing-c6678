...
{
	return CSL_FEXT (tcp2Regs->TCPEND, TCP2_TCPEND_ENDIAN_W);
}
...
{
	return CSL_FEXT (tcp2Regs->TCPEND, TCP2_TCPEND_ENDIAN_I0);
}
...
{
	CSL_FINS (tcp2Regs->TCPEND, TCP2_TCPEND_ENDIAN_W, endianMode);
...
{
	CSL_FINS (tcp2Regs->TCPEND, TCP2_TCPEND_ENDIAN_I0, endianMode);
...
{
	CSL_FINST (tcp2Regs->TCPEND, TCP2_TCPEND_ENDIAN_I0, NATIVE16);
	CSL_FINST (tcp2Regs->TCPEND, TCP2_TCPEND_ENDIAN_W, NATIVE8);
...
{
	CSL_FINST (tcp2Regs->TCPEND, TCP2_TCPEND_ENDIAN_I0, 32BITS);
	CSL_FINST (tcp2Regs->TCPEND, TCP2_TCPEND_ENDIAN_W, 32BITS);
