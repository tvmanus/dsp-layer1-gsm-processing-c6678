...
MEMORY
{
 	GEM1_TEXT_MEM	: origin = 0x11800000 length = 0x00020000 //Bottom 128 KB for data and text
// 	GEM1_DATA_MEM	: origin = 0x11810000 length = 0x00000010
//	GEM1_FLAG_MEM   : origin = 0x1183FFFF length = 0x00000001
} 
SECTIONS
{
  boot > 0x11800000
  ...
  .far:       >       GEM1_TEXT_MEM
  .stack:     >       GEM1_TEXT_MEM
  .switch:    >       GEM1_TEXT_MEM
  .sysmem:    >       GEM1_TEXT_MEM
  .csl_vect:  >		  GEM1_TEXT_MEM
