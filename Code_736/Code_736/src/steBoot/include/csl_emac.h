...
#define EMAC_NUMCORES                   3
/**< Number of cores                                                        */        
#define EMAC_NUMCHANNELS                8                   
 ...
 *  @verbatim
		...
		//packet size
	    ecfg.PktMTU = 10240;
		//Total number of MAC addresses for all receive channels
 ...
 *  @verbatim
        ...
        EMAC_setReceiveFilter(hEMAC, EMAC_RXFILTER_DIRECT, 1);
