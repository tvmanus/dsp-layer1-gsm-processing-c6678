 ...
 * ============================================================================
 */
#pragma CODE_SECTION(MDIO_open, ".textDDR")
 ...
 * ============================================================================
 */
#pragma CODE_SECTION(MDIO_close, ".textDDR")
 ...
 * ============================================================================
 */
#pragma CODE_SECTION(MDIO_getStatus, ".text")
...
#pragma CODE_SECTION(MDIO_initPHY, ".textDDR")
...
//STE_WARN. A commented code was there removed for code cleanup. If needed compare with original library.

    /* Reset the PHY we plan to use */
    PHYREG_write( PHYREG_CONTROL, phyAddr, PHYREG_CONTROL_RESET );
    PHYREG_waitResultsAck( i, ack );

	i = i; //dummy to avoid warning...
 ...
 * ============================================================================
 */
#pragma CODE_SECTION(MDIO_initContinue, ".textDDR")
...
static Uint32 MDIO_initContinue( MDIO_Device *pd )
{
...

	{
		...
		for (index =0; index < 32;index++)
		{
 	   		PHYREG_read( PHYREG_STATUS, index );
    		PHYREG_waitResults( tmp1 );

			/* Copy the Status value into the Status. */
			StatusRegister [index] = tmp1;
		}
		StatusRegister[0] = StatusRegister[0]; //dummy to avoid warning...
	}
